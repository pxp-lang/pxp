...
snap!(
    snapper,
    clone_property_fetch,
    process("fixtures/clone/clone-property-fetch.php")
);
snap!(
    snapper,
    clone_function_call,
    process("fixtures/clone/clone-function-call.php")
);
snap!(
    snapper,
    clone_function_call_args,
...
snap!(
    snapper,
    property_hooks_empty,
    process("fixtures/property-hooks/empty.php")
);
snap!(
    snapper,
    property_hooks_abstract_get,
    process("fixtures/property-hooks/abstract-get.php")
);
snap!(
    snapper,
    property_hooks_abstract_set,
    process("fixtures/property-hooks/abstract-set.php")
);
snap!(
    snapper,
    property_hooks_expression_body,
    process("fixtures/property-hooks/expression-body.php")
);
snap!(
    snapper,
    property_hooks_block_body,
    process("fixtures/property-hooks/block-body.php")
);
snap!(
    snapper,
    property_hooks_parameter_list,
    process("fixtures/property-hooks/parameter-list.php")
);
...
snap!(
    ...
    process("fixtures/asymmetric-visibility/visibility.php")
);
snap!(
    snapper,
    asymmetric_visibility_promoted_property,
