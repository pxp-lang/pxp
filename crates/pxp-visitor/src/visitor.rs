...
fn visit_function_closure_creation_expression(&mut self, node: &FunctionClosureCreationExpression) {
...
fn visit_static_variable_method_call_expression(&mut self, node: &StaticVariableMethodCallExpression) {
   walk_static_variable_method_call_expression(self, node);
}


fn visit_static_method_closure_creation_expression(&mut self, node: &StaticMethodClosureCreationExpression) {
   walk_static_method_closure_creation_expression(self, node);
}


fn visit_static_variable_method_closure_creation_expression(&mut self, node: &StaticVariableMethodClosureCreationExpression) {
